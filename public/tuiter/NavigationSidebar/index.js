...
const NavigationSidebar = () => {
    ...
    return(`
        <div class="list-group wd-bottom-margin wd-no-wrap-text">
            ...
            <a class="list-group-item list-group-item-action wd-navigation-item" href="../home.html">
                <i class="fas fa-home"></i>
                <span class="d-none d-xl-block wd-nav-title">Home</span></a>
            <a class="list-group-item list-group-item-action wd-navigation-item" href=../explore.html">
                <i class="fas fa-hashtag"></i>
                <span class="d-none d-xl-block wd-nav-title">Explore</span></a>
            <a class="list-group-item list-group-item-action wd-navigation-item" href="../notifications.html">
                <i class="fas fa-bell"></i>
                <span class="d-none d-xl-block wd-nav-title">Notifications</span></a>
            <a class="list-group-item list-group-item-action wd-navigation-item" href="../messages.html">
                <i class="fas fa-envelope"></i>
                <span class="d-none d-xl-block wd-nav-title">Messages</span></a>
            <a class="list-group-item list-group-item-action wd-navigation-item" href="../bookmarks.html">
                <i class="fas fa-bookmark"></i>
                <span class="d-none d-xl-block wd-nav-title">Bookmarks</span></a>
            <a class="list-group-item list-group-item-action wd-navigation-item" href="../lists.html">
                <i class="fas fa-list"></i>
                <span class="d-none d-xl-block wd-nav-title">Lists</span></a>
            <a class="list-group-item list-group-item-action wd-navigation-item" href="../profile.html">
                <i class="fas fa-user"></i>
                <span class="d-none d-xl-block wd-nav-title">Profile</span></a>
            <a class="list-group-item list-group-item-action wd-navigation-item" href="../more.html">
